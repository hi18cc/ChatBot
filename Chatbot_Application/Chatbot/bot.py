                        ...
                        if res:
                            ...
                            for j in range(max2):
                                if(max2 == 1):
                                    ...
                                    ans = ans + " " + res[j][0] + " from " + res[j][2] + " participates in " + res[j][1] + "."
                            connection.close()
                            return ans 
                    connection.close()
                    return "Could not find player"
                    ...
                    for i in range(0,max):
                        if KeyValues.KeyValues.Contingent_Keys[i][0] in temp2:
                            ...
                            if "silver" in inp.lower():
                                ...
                                return ans
                    connection.close()
                    return "Cannot find province or territory"
                ...
                # returns the date for the next game of a contingent and/or a sport
                            ...
                            for j in range(0,max2):
                                if KeyValues.KeyValues.Sport_Keys[j][0] in temp2:
                                    ...
                                    for k in range(0,max3):
                                        ans = ans + res[k][0] + " " + res[k][3] + " " + res[k][4] + ". "
                                    connection.close()
                                    return ans
                    ...
                    for i in range(0,max):
                        if KeyValues.KeyValues.Contingent_Keys[i][0] in temp2:
                            ...
                            max3 = len(res)
                            for k in range(0, max3):
                                ans = ans + res[k][0] + " " + res[k][1] + " " + res[k][3] + " " + res[k][4] + ". "
                            connection.close()
                            return ans
                    ...
                    for i in range(0,max2):
                        if KeyValues.KeyValues.Sport_Keys[i][0] in temp2:
                            ...
                            max3 = len(res)
                            for k in range(0,max3):
                                ans = ans + res[k][0] + " " + res[k][2] + " " + res[k][3] + " " + res[k][4] + ". "
                            connection.close()
                            return ans
